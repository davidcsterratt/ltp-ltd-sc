...
sims <- run.kasims(c("volume4.ka", "agents4.ka", "ca4.ka", "cam4.ka", "cb4.ka", "camkii4.ka"),
...
plot.ts(sims[["CaMKIIp"]],ylab="#", hue=0.5, xlim=c(0, 20), main="CaMKIIp", offset=0, time.units="s")
