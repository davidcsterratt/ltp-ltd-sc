...
plot.ts(sims.a[["CaMKIIp"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaMKII", offset=0, time.units="s")
plot.ts(sims.a[["CaMKIIhexp"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaMKIIhexp", offset=0, time.units="s")
plot.ts(sims.a[["CaPP3"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaPP3", offset=0, time.units="s")
plot.ts(sims.a[["PP1"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="PP1", offset=0, time.units="s")
...
plot.ts(sims.b[["CaMKIIp"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaMKII", offset=0, time.units="s")
plot.ts(sims.b[["CaMKIIhexp"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaMKIIhexp", offset=0, time.units="s")
plot.ts(sims.b[["CaPP3"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaPP3", offset=0, time.units="s")
plot.ts(sims.b[["PP1"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="PP1", offset=0, time.units="s")
...
plot.ts(sims.c[["CaMKIIp"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaMKII", offset=0, time.units="s")
plot.ts(sims.c[["CaMKIIhexp"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaMKIIhexp", offset=0, time.units="s")
plot.ts(sims.c[["CaPP3"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="CaPP3", offset=0, time.units="s")
plot.ts(sims.c[["PP1"]],ylab="#", hue=0.5, xlim=c(0, tstop), main="PP1", offset=0, time.units="s")
